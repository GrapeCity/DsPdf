...
namespace GcPdfWeb.Samples.Basics
{
    ...
    public class TextAroundImages
    {
        public void CreatePDF(Stream stream)
        {
            ...
            var imgPuffins = Image.FromFile("Resources/Images/puffins.jpg");
            var rectPuffins = new RectangleF(100, 70, 180, 180);
            var imgReds = Image.FromFile("Resources/Images/reds.jpg");
            var rectReds = new RectangleF(300, 280, 180, 180);
            var imgLavender = Image.FromFile("Resources/Images/lavender.jpg");
            ...
            RectangleF[] rectsPuffins;
            g.DrawImage(imgPuffins, rectPuffins, null, ia, out rectsPuffins);
            RectangleF[] rectsReds;
            g.DrawImage(imgReds, rectReds, null, ia, out rectsReds);
            RectangleF[] rectsLavender;
            g.DrawImage(imgLavender, rectLavender, null, ia, out rectsLavender);
            ...
            tl.MarginLeft = tl.MarginTop = tl.MarginRight = tl.MarginBottom = 72 / 2;
