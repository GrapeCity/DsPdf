...
namespace GcPdfWeb.Samples.Basics
{
    ...
    public class InlineImages
    {
        public void CreatePDF(Stream stream)
        {
            ...
            var imgPuffins = Image.FromFile("Resources/ImagesBis/puffins-small.jpg");
            var imgFerns = Image.FromFile("Resources/ImagesBis/ferns-small.jpg");
            // and the image alignment to use:
